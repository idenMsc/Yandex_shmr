...
_$AccountResponseModelImpl _$$AccountResponseModelImplFromJson(
        Map<String, dynamic> json) =>
    _$AccountResponseModelImpl(
...
Map<String, dynamic> _$$AccountResponseModelImplToJson(
        _$AccountResponseModelImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
